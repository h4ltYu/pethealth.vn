...
f("body").append(tdcAdminWrapperUI.$placeholder);tdcAdminWrapperUI.$savePage=f(".tdc-save-page");tdcAdminWrapperUI.$savePage.on("click",tdcAdminWrapperUI.savePostHandler);f(document).bind("click",function(b){f("#tdc-context-menu").hide()})},savePostHandler:function(b){tdcAdminWrapperUI.$savePage.hasClass("tdc-saving-loader")||(tdcAdminWrapperUI.$savePage.addClass("tdc-saving-loader"),tdcSavePost.savePost(),tdcSavePost.updateHeaderTemplate())},setHelperClass:function(b){tdcAdminWrapperUI._helperClass!==
...
!0,!1),a=tdcIFrameData.getModel(c),b.isUndefined(c)&&new tdcNotice.notice("_getSourceCol Error: Tne column model not in structure data!",!0,!1),a=tdcIFrameData._parseModelWidthAttrs(a)},getShortcodeFromData:function(a){a.getShortcode="";var c=tdcIFrameData.getFirstModelByZoneType("tdc_content");tdcIFrameData._checkModelData(c,a)},getHeaderShortcodeFromData:function(){var a={};["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(c){var d=
{error:e,getShortcode:""},g=tdcIFrameData.getFirstModelByZoneType(c);tdcIFrameData._checkModelData(g,d);b.isUndefined(d.error)?b.isUndefined(d.getShortcode)?delete a[c]:a[c]=d.getShortcode:new tdcNotice.notice(d.errors,!0,!1)});if(!b.isEmpty(a))return a},bindViewsModelsWrappers:function(a,c,e,d){if(b.isEmpty(a)&&(b.isUndefined(d)&&(d=0),!b.isUndefined(c))){var g=[];switch(d){case 0:var m=[];e.find(".tdc-zone").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)});if(c.models.length!==
m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Error at zones: "+c.models.length+"(models) : "+m.length+"(dom)"};return}d++;b.each(m,function(c,b,e){b=f(c);e=b.data("type");e=tdcIFrameData.getFirstModelByZoneType(e);b.data("model_id",e.cid);e.set("blockUid",b.attr("id"));e.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:e,el:c});e.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),b,d)});d--;return;case 1:e.find(".tdc-row").each(function(){var a=
f(this);a.parents(".menu-item").length||g.push(a)});if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Error at rows: "+c.models.length+"(models) : "+g.length+"(dom)"};return}break;case 2:e.find(".tdc-columns:first").children(".tdc-column").each(function(){var a=f(this);a.parents(".menu-item").length||g.push(a)});if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns: "+c.models.length+"(models) : "+g.length+"(dom)",
level:d};return}break;case 3:e.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row").each(function(){var a=f(this);a.parents(".menu-item").length||g.push(a)});if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns elements: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};return}break;case 4:e.find(".tdc-inner-columns:first").children(".tdc-inner-column").each(function(){var a=f(this);a.parents(".menu-item").length||
g.push(a)});if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at inner columns: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};return}break;case 5:if(e.find(".tdc-elements:first").children(".tdc-element").each(function(){var a=f(this);a.parents(".menu-item").length||g.push(a)}),c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at elements: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};return}}d++;
b.each(g,function(e,g,m){g=c.models[g];m=f(e);m.data("model_id",g.cid);g.set("html",e.innerHTML,{silent:!0});if(5===g.get("level")){var k=m.data("td-block-uid");if(b.isUndefined(k)){var l=m.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");l.length&&(k=l.attr("id"))}}else 3===g.get("level")?(l=m.find(".tdc-inner-row"),l.length&&(k=l.attr("id"))):1===g.get("level")&&(k=m.attr("id"));g.set("blockUid",k);new tdcIFrameData.TdcLiveView({model:g,el:e});!m.hasClass("tdc-element")&&g.has("childCollection")&&
0<b.size(g.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,g.get("childCollection"),m,d)});d--}},changeRowModel:function(a,c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var m=e[0].charAt(0)+"/"+e[0].charAt(1),k=d.at(0),f=k.get("attrs");b.isUndefined(f)?k.set("attrs",{width:m}):(f=b.clone(f),f.width=m,k.set("attrs",f));d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[1].charAt(0)+"/"+e[1].charAt(1)},
type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(k,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");k=d.at(0);f=k.get("attrs");var n=k.get("childCollection"),p=d.at(1),q=p.get("childCollection");b.isUndefined(f)||(f=b.clone(f),delete f.width,k.set("attrs",f));b.isUndefined(n)&&(n=
new tdcIFrameData.TdcCollection,k.set("childCollection",n));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",k);n.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",k);n.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(k,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=c.split("_");
e=e.split("_");m=e[0].charAt(0)+"/"+e[0].charAt(1);var t=e[1].charAt(0)+"/"+e[1].charAt(1);k=d.at(0);f=k.get("attrs");p=d.at(1);var v=p.get("attrs");q=p.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",q)),b.each(d.models,
function(a,c,b){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));f=b.clone(f);f.width=m;k.set("attrs",f);c[0]!==e[0]&&tdcIFrameData.changeColumnModel(k,c[0],e[0]);m=b.clone(v);m.width=t;p.set("attrs",m);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(p,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),m=a.get("tag"),k="vc_column";c=c.split("_");var f=e.split("_");if("vc_row"===m||"vc_row_inner"===m){"vc_row_inner"===
m&&(k="vc_column_inner");if(f.length>c.length)for(m=0;m<f.length;m++){e="";for(var n=0;n<f[m].length;n++)e+=f[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));if(m<c.length){var p=d.at(m);n=p.get("attrs");var q=b.clone(n);q.width=e;p.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:k,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(m=0;m<c.length;m++)if(m<f.length){p=d.at(m);n=p.get("attrs");q=b.clone(n);e="";for(n=0;n<f[m].length;n++)e+=f[m].charAt(n)+"/";
""!==e&&(e=e.substring(0,e.length-1));q.width=e;p.set("attrs",q);var t=p}else{p=d.at(f.length);a=p.get("childCollection");var v=t.get("childCollection");b.isUndefined(v)&&(v=new tdcIFrameData.TdcCollection,t.set("childCollection",v));b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",t);v.add(a)});tdcIFrameData.removeModel(p)}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)}},changeColumnModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=
a.get("childCollection");if(!b.isUndefined(d)&&d.length){var m=a.get("attrs");!b.isUndefined(m)&&b.has(m,"width");b.each(d.models,function(d,g,m){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var f="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(f=c===e.length-1?f+a.width:f+(a.width+"_"))});f=f.replace(/\//g,"");"12_12"!==f&&"23_13"!==f&&"13_23"!==f&&"13_13_13"!==f&&(f="");if("11"===c)if("23"===
e)if("23_13"===f){var l=d.at(0),k=d.at(1);m=l.get("attrs");g=k.get("attrs");m=b.clone(m);g=b.clone(g);m.width="1/2";g.width="1/2";l.set("attrs",m);k.set("attrs",g)}else if("13_23"===f)l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/2",g.width="1/2",l.set("attrs",m),k.set("attrs",g);else if("13_13_13"===f){l=d.at(0);k=d.at(1);d=d.at(2);m=l.get("attrs");g=k.get("attrs");var h=d.get("attrs");m=b.clone(m);g=b.clone(g);b.clone(h);m.width="1/2";g.width="1/2";l.set("attrs",
m);k.set("attrs",g);g=d.get("childCollection");if(!b.isUndefined(g)&&g.length){var n=k.get("childCollection");b.isUndefined(n)&&(n=new tdcIFrameData.TdcCollection,k.set("childCollection",n));b.each(g.models,function(a,c,b){n.add(a);a.set("parentModel",k)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){l=d.at(0);m=l.get("attrs");m=b.clone(m);var r=l.get("childCollection");delete m.width;l.set("attrs",m);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r));var w=
0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}}else{if("13"===e&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),
b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("23"===c)if("11"===e)if("12_12"===f)l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/3",g.width="1/3",l.set("attrs",m),k.set("attrs",g),g=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(g);else{if(d.models.length)for(l=d.at(0),m=l.get("attrs"),
m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else{if("13"===e&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&
(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===f||"12_12"!==f&&"23_13"!==f&&"13_23"!==f&&"13_13_13"!==f){if(d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&
(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===f&&d.models.length&&(l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m.width="1/3",g.width="1/3",l.set("attrs",m),k.set("attrs",g),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},
type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===f||"12_12"!==f)&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}})}}},changeInnerRowModel:function(a,
c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),m=q.get("childCollection"),h=d.at(1),f=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),
b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m)),!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),tdcIFrameData.removeModel(h)):(n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),
f=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,h.set("childCollection",f)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",h);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var m=q.get("childCollection");h=d.at(1);var f=h.get("childCollection");b.isUndefined(t)||(t=b.clone(t),delete t.width,
q.set("attrs",t));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m));!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)});tdcIFrameData.removeModel(h)}else n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1);c=n[1].charAt(0)+"/"+n[1].charAt(1);var q=d.at(0),t=q.get("attrs");b.isUndefined(t)?q.set("attrs",{width:p}):(t=b.clone(t),t.width=p,q.set("attrs",t));h.set("attrs",{width:c});d.add(h);3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;b.map(a.models,function(a,e){var d=a.get("attrs");b.has(d,"width")&&(c=b.isUndefined(c)?d.width.replace("/",""):c+("_"+d.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
tdcContextMenu._model.get("tag"),b=tdcContextMenu._model.get("attrs");f=_.clone(b);var e=window.tdcAdminSettings.mappedShortcodes[d].tdc_style_params;if(!_.isUndefined(e)){for(var a in b){b=!1;for(var c=0;c<e.length;c++)if(a===e[c]){b=!0;break}if("tdc_zone"!==d||"type"!==a)b||delete f[a]}a=JSON.parse(tdcUtil.b64DecodeUnicode(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values));Array.isArray(a)&&(a=a[0]);for(var m in a)f.hasOwnProperty(m)||(f[m]=a[m])}tdcContextMenu._model.set("attrs",f);
tdcSidebarController.onUpdate(tdcContextMenu._model)}tdcContextMenu.hide()});tdcContextMenu.$_saveShortcode.on("click",tdcContextMenu.saveShortcodeHandler);tdcContextMenu.$_deleteShortcode.on("click",tdcContextMenu.deleteHandler);tdcContextMenu.$_cloneShortcode.on("click",tdcContextMenu.cloneHandler);tdcContextMenu.$_clearShortcode.on("click",function(f){var d={error:void 0,getShortcode:""};if(!_.isUndefined(tdcContextMenu._model)){f=tdcContextMenu._model.get("tag");var b=tdcContextMenu._model.get("childCollection");
if(!_.isUndefined(b))if("vc_column"===f||"vc_column_inner"===f)b.reset();else if("vc_row"===f||"vc_row_inner"===f)_.map(b.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()});else if("tdc_zone"===f){var e;_.map(b.models,function(a,b){_.isUndefined(e)&&(e=a);var c=a.get("childCollection");_.map(c.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()})});b=new tdcIFrameData.TdcCollection;b.add(e,{at:0});tdcContextMenu._model.set("childCollection",
b)}tdcIFrameData._checkModelData(tdcContextMenu._model,d);if(!_.isUndefined(d.getShortcode)){d=tdcContextMenu._getCurrentElementOver();b="tdc-element-column";if("vc_column_inner"===f||"vc_row_inner"===f||"vc_row"===f)b="tdc-element-inner-column";d.find(".tdc-elements").html('<div class="tdc-element-empty '+b+'" title="Empty element that should be removed by composer"></div>').addClass("tdc-dropped");tdcSidebarController.onUpdate(tdcContextMenu._model)}}tdcContextMenu.hide()})},copyShortcodeHandler:function(f){f=
{error:void 0,getShortcode:""};_.isUndefined(tdcContextMenu._model)||tdcIFrameData._checkModelData(tdcContextMenu._model,f);var d=tdcContextMenu._model.get("tag"),b=tdcContextMenu._model.get("attrs"),e=tdcContextMenu._getCurrentElementOver();tdcUtil.setStorageItem("copyShortcodeType",d);tdcUtil.setStorageItem("copyShortcodeAttrs",tdcUtil.b64EncodeUnicode(JSON.stringify(b)));tdcUtil.setStorageItem("copySourceCol",tdcIFrameData._getSourceCol(e));if("vc_column"===d||"vc_column_inner"===d){var a="";f=
tdcContextMenu._model.get("childCollection");_.isUndefined(f)||_.map(f.models,function(b,d){var c={error:void 0,getShortcode:""};tdcIFrameData._checkModelData(b,c);_.isUndefined(c.getShortcode)||(a+=c.getShortcode)});tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(a))}else tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(f.getShortcode));tdcContextMenu.hide()},cutShortcodeHandler:function(f){tdcContextMenu.copyShortcodeHandler(f);tdcContextMenu.deleteHandler(f,!0)},
pasteBeforeShortcodeHandler:function(f){var d=f=tdcContextMenu._getCurrentElementOver(),b=tdcUtil.getStorageItem("copyShortcodeType");switch(b){case "vc_row":if(tdcOperationUI.isRow(f))d.before(tdcAdminWrapperUI.$placeholder);else if(tdcOperationUI.isZone(f)||tdcOperationUI.isColumn(f)||tdcOperationUI.isInnerRow(f)||tdcOperationUI.isInnerColumn(f)||tdcOperationUI.isElement(f)){new tdcNotice.showNotice("Ooops! The shortcode can't be copied!",{type:"info"});return}break;case "vc_column":if(tdcOperationUI.isRow(f)||
