...
jQuery().ready(function() {
    ...
    if ( jQuery('#td_panel_big_form').length ) {
        ...
        panel_mobile_settings_show_on_amp_checkbox();
    }
});

function panel_mobile_settings_show_on_amp_checkbox() {
    ...
    if ( mobileThemeSettingsPanel.length ) {
        ...
        mobileThemeSettings.on('click', '.tdm_setting_toggle .td-checkbox, .tdm_setting_toggle .td-checkbox-active', function(){
            mobileThemeSettings.find('.td_panel_box_amp_ads, .td_panel_box_amp_analytics').toggleClass('tdm_settings_disabled');
        });
    }
}
