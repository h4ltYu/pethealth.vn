    ...
    function get_modified_date() {
        ...
        $buffy = '';
            ...
            if (td_util::get_option('tds_p_show_modified_date') == 'yes') {
                ...
                $buffy .= '<time class="entry-date updated td-module-date' . $visibility_class . '" datetime="' . date(DATE_W3C, $td_article_date_unix) . '" >' . "Modified date: " . get_the_modified_date(get_option( 'date_format' ), $this->post->ID) . '</time>';
                $buffy .= '</span>';
            }
