        ...
        if ( !is_null( $this->post_thumb_id ) or ( $tds_hide_featured_image_placeholder != 'hide_placeholder' ) ) {
            ...
            if ( !is_null( $this->post_thumb_id ) ) {
                ...
                if ( td_util::get_option('tds_thumb_td_265x198' ) != 'yes' ) {
                    ...
                    $td_temp_image_url[0] = td_global::$get_template_directory_uri . '/images/thumb-disabled/td_265x198.png';
                ...
                $td_temp_image_url[1] = '265';
                $td_temp_image_url[2] = '198';
                $td_temp_image_url[0] = td_global::$get_template_directory_uri . '/images/no-thumb/td_265x198.png';
